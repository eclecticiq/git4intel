...
def make_incident(user_id, target_org, tlp, tlp_dist=None):
    ...
    indicate = stix2.v21.Relationship(created_by_ref=user_id,
                                      ...
                                      object_marking_refs=[tlp])
    mitre_id = "attack-pattern--d3df754e-997b-4cf9-97d4-70feb3120847"
...
def main():
    ...
    g4i.store_objects(user_id="identity--084bcd40-a2ed-4420-84db-04444bd0e763",
    ...
    # print(g4i.store_objects(user_id=users1[1], objects=objects))
