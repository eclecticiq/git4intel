...
def get_locations(created_by_ref):
    ...
    un_m49 = [
        ...
        ['Africa', 'Sub-Saharan Africa', 'Eastern Africa', 'South Sudan', 'SSD'],
        ...
        ['Africa', 'Sub-Saharan Africa', 'Western Africa', 'Burkina Faso', 'BFA'],
        ['Africa', 'Sub-Saharan Africa', 'Western Africa', 'Cabo Verde', 'CPV'],
        ['Africa',
        'Sub-Saharan Africa',
        'Western Africa',
        'Côte d’Ivoire',
        ...
        ['Africa', 'Sub-Saharan Africa', 'Western Africa', 'Mauritania', 'MRT'],
        ['Africa', 'Sub-Saharan Africa', 'Western Africa', 'Niger', 'NER'],
        ['Africa', 'Sub-Saharan Africa', 'Western Africa', 'Nigeria', 'NGA'],
        ['Africa', 'Sub-Saharan Africa', 'Western Africa', 'Saint Helena', 'SHN'],
        ['Africa', 'Sub-Saharan Africa', 'Western Africa', 'Senegal', 'SEN'],
        ['Africa', 'Sub-Saharan Africa', 'Western Africa', 'Sierra Leone', 'SLE'],
        ...
        ['Americas', 'Northern America', 'Saint Pierre and Miquelon', 'SPM', ''],
        ['Americas', 'Northern America', 'United States of America', 'USA', ''],
        ...
        ['Oceania', 'Australia and New Zealand', 'Christmas Island', 'CXR', ''],
        ['Oceania',
        ...
        ['Oceania', 'Micronesia', 'Micronesia (Federated States of)', 'FSM', ''],
